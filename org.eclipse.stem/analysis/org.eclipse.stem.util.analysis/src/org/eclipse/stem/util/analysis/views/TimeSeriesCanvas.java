...
public class TimeSeriesCanvas extends Canvas {
	 ...
	 * plotted.In the new version of BIRT cycleNumbers must be a DOUBLE
	 * 
	 * @see #relativeValues
	 */
	...
	public static void setColorDefs(
		...
		for (int i = 0; i < lsList.size(); i++) {
			...
			if ((propertiesToPlot != null) && (propertiesToPlot.size() > i)) {
				final String propertyName = propertiesToPlot.get(i);
...
//				}
				...
				lsList.get(i).setSeriesIdentifier(propertyName);
