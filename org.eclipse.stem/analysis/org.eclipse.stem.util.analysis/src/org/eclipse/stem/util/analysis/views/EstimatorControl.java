...
public class EstimatorControl extends AnalysisControl {
			...
			final SelectionEvent e) {
				...
				if(parameterEstimatorWizard != null) {
					...
					try {
						...
						dataMap = loader.parseAllFiles(CSVscenarioLoader.UNKNOWN_POP_IDENTIFIER_KEY, maxResolution);
	...
	public Map<String, Object> getControlParametersMap() {
		// add nothing for now
		controlParametersMap.put(MIN_S_KEY, Double.valueOf(getMinThresholdS()));
		controlParametersMap.put(MIN_E_KEY, Double.valueOf(getMinThresholdE()));
		controlParametersMap.put(MIN_I_KEY, Double.valueOf(getMinThresholdI()));
		controlParametersMap.put(MIN_R_KEY, Double.valueOf(getMinThresholdR()));
		
		controlParametersMap.put(MAX_S_KEY, Double.valueOf(getMaxThresholdS()));
		controlParametersMap.put(MAX_E_KEY, Double.valueOf(getMaxThresholdE()));
		controlParametersMap.put(MAX_I_KEY, Double.valueOf(getMaxThresholdI()));
		controlParametersMap.put(MAX_R_KEY, Double.valueOf(getMaxThresholdR()));
