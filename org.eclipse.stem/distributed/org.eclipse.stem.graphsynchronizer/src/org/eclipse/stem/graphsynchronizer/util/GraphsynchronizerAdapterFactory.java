...
public class GraphsynchronizerAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected GraphsynchronizerSwitch<Adapter> modelSwitch =
		new GraphsynchronizerSwitch<Adapter>() {
			@Override
			public Adapter caseSynchGraphPartitioner(SynchGraphPartitioner object) {
				return createSynchGraphPartitionerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.graphsynchronizer.SynchGraphPartitioner <em>Synch Graph Partitioner</em>}'.
	 * <!-- begin-user-doc -->
...
} //GraphsynchronizerAdapterFactory
