...
public class StochasticSolverPropertyEditorAdapter extends org.eclipse.stem.core.solver.SolverPropertyEditorAdapter
		implements Adapter {
	...
	public SolverPropertyEditor createSolverPropertyEditor(
		...
		return new StochasticSolverPropertyEditor(
