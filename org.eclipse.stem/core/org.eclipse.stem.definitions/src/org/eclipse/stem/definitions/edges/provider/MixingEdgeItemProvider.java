...
public class MixingEdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MixingEdge_useAbsoluteValues_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_MixingEdge_useAbsoluteValues_feature", "_UI_MixingEdge_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EdgesPackage.Literals.MIXING_EDGE__USE_ABSOLUTE_VALUES,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns MigrationEdge.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/custom16/mixing.png")); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MixingEdge.class)) {
