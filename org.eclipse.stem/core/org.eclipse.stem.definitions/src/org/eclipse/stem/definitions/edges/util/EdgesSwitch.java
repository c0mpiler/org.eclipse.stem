	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EdgesPackage.MIGRATION_EDGE: {
				...
				if (result == null) result = caseSanityChecker(migrationEdge);
			...
			case EdgesPackage.MIGRATION_EDGE_LABEL: {
				...
				if (result == null) result = caseModifiable(migrationEdgeLabel);
				...
				if (result == null) result = caseSanityChecker(migrationEdgeLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EdgesPackage.MIXING_EDGE: {
				...
				if (result == null) result = caseSanityChecker(mixingEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdgesPackage.MIXING_EDGE_LABEL: {
				...
				if (result == null) result = caseModifiable(mixingEdgeLabel);
				...
				if (result == null) result = caseSanityChecker(mixingEdgeLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EdgesPackage.POPULATION_EDGE: {
				...
				if (result == null) result = caseSanityChecker(populationEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
