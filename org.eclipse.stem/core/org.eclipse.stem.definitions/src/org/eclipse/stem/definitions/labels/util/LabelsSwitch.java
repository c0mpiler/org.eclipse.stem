	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LabelsPackage.AREA_LABEL: {
				...
				if (result == null) result = caseSanityChecker(areaLabel);
			...
			case LabelsPackage.COMMON_BORDER_RELATIONSHIP_LABEL: {
				...
				if (result == null) result = caseSanityChecker(commonBorderRelationshipLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LabelsPackage.PHYSICAL_RELATIONSHIP_LABEL: {
				...
				if (result == null) result = caseSanityChecker(physicalRelationshipLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LabelsPackage.POPULATION_LABEL: {
				...
				if (result == null) result = caseSanityChecker(populationLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LabelsPackage.RELATIVE_PHYSICAL_RELATIONSHIP_LABEL: {
				...
				if (result == null) result = caseSanityChecker(relativePhysicalRelationshipLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LabelsPackage.TRANSPORT_RELATIONSHIP_LABEL: {
				...
				if (result == null) result = caseSanityChecker(transportRelationshipLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LabelsPackage.ROAD_TRANSPORT_RELATIONSHIP_LABEL: {
				...
				if (result == null) result = caseSanityChecker(roadTransportRelationshipLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case LabelsPackage.EARTH_SCIENCE_LABEL: {
				...
				if (result == null) result = caseSanityChecker(earthScienceLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
