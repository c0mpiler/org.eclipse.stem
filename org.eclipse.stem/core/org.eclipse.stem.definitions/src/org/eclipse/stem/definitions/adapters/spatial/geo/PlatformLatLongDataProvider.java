...
public class PlatformLatLongDataProvider implements LatLongDataProvider {
	...
	private void setPreferences() {
		...
		if(preferenceStore !=null) {
			isSampling = preferenceStore.getBoolean(PreferenceConstants.DOWN_SAMPLE_LAT_LONG_DATA_BOOLEAN_PREFERENCE);
			sampleFrequency = preferenceStore.getInt(PreferenceConstants.LAT_LONG_SAMPLE_FREQUENCY_INTEGER_PREFERENCE);
			reportIOExceptions = preferenceStore.getBoolean(PreferenceConstants.REPORT_IO_EXCEPTIONS_BOOLEAN_PREFERENCE);
			useLowerResolutionLatLongData = preferenceStore.getBoolean(PreferenceConstants.USE_LOWER_RESOLUTION_LAT_LONG_DATA_BOOLEAN_PREFERENCE);
		}
