...
/**
 * This class is used to NLS'd strings for {@link Logger} properties. 
 */
public class SimulationLoggerPropertyStringProviderAdapterFactory extends
		LoggerAdapterFactory implements PropertyStringProviderAdapterFactory {
	 ...
	 * Default Constructor
	 */
	public SimulationLoggerPropertyStringProviderAdapterFactory() {
		super();
	...
	public Adapter createLoggerAdapter() {
		...
		if (adapter == null) {
			// No
			adapter = new SimulationLoggerPropertyStringProviderAdapter();
	 ...
	 */
	public static class SimulationLoggerPropertyStringProviderAdapter extends
		...
		public String getPropertyToolTip(
			...
			final EStructuralFeature feature = (EStructuralFeature) descriptor
					.getFeature(null);
			return LoggerWizardMessages.getString(feature.getName()
					+ TT_SUFFIX);
		} // getPropertyToolTip
