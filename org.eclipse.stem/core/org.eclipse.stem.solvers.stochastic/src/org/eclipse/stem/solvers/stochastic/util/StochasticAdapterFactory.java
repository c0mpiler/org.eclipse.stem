...
public class StochasticAdapterFactory extends AdapterFactoryImpl {
	...
	protected StochasticSwitch<Adapter> modelSwitch =
		new StochasticSwitch<Adapter>() {
			@Override
			public Adapter caseStochastic(Stochastic object) {
				return createStochasticAdapter();
			}
			@Override
			public Adapter caseStandardStochastic(StandardStochastic object) {
				return createStandardStochasticAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.solvers.stochastic.Stochastic <em>Stochastic</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.solvers.stochastic.StandardStochastic <em>Standard Stochastic</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
