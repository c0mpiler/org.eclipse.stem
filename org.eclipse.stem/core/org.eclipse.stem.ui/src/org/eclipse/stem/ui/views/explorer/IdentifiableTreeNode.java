...
abstract public class IdentifiableTreeNode {
	...
	/**
	 * This class is a {@link IdentifiableTreeNode} that represents
	 * {@link org.eclipse.stem.core.solver.Solver}s.
	 */
	public static class SolversTreeNode extends IdentifiableTreeNode {
		...
		public SolversTreeNode(IProject project) {
			super(project, Messages.getString("EXPLORER.SOLVERS_FOLDER"),
					NewSTEMProjectWizard.SOLVERS_FOLDER_NAME,
					org.eclipse.stem.ui.ISharedImages.SOLVERS_FOLDER_ICON);
		}
	} // SolversTreeNode
