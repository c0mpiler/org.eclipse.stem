...
public interface ISharedImages {
	 ...
	 * {@link org.eclipse.stem.core.experiment.Experiment}.
	 */
	String SOLVERS_ICON = "solvers.image"; //$NON-NLS-1$

	/**
	 * This image is the icon that represents an
	 * {@link org.eclipse.stem.core.experiment.Experiment}.
	 */
	String SOLVERS_FOLDER_ICON = "solvers_model_file.image"; //$NON-NLS-1$
	...
	/**
	 * This image is the icon that represents a {@link Logger}.
	 */
	String LOGGER_ICON = "logger.image"; //$NON-NLS-1$

	/**
	 * This image is the icon that represents a {@link Logger}.
	 */
	String LOGGER_FOLDER_ICON = "logger_model_file.image"; //$NON-NLS-1$
