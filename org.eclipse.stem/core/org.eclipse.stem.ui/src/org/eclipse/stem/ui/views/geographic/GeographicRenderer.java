...
public abstract class GeographicRenderer extends Composite implements
	...
	/*
	 * reports the gain and log or linear scale
	 */
	 ...
	 */
	abstract public void render(StemPolygonsList polygonsToRender, ISimulation simulation);

	protected java.awt.Color getColorForRelativeValue( final double relativeValue) {
		return null;
	}
