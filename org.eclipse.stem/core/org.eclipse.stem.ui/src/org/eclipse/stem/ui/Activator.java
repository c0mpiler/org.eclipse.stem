...
public class Activator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		//MigrationProjectChangeListener.getInstance().start();
		...
		for (IConfigurationElement element : elements) {
			...
			ColorProviderAdapterFactory.INSTANCE.addAdapterFactory(
					(AdapterFactory)factoryInstance, (Class<? extends ColorProvider>)providerClass, name);
		}
	} // start
...
//		final String ICON_PATH_PREFIX = "icons/full/customobj16/"; //$NON-NLS-1$
		...
		registry.put(ISharedImages.SOLVERS_FOLDER_ICON, imageDescriptorFromPlugin(
				PLUGIN_ID, CUSTOM_ICON_PATH_PREFIX2 + "SolversModelFile.png")); //$NON-NLS-1$
		...
		registry.put(ISharedImages.LOGGER_ICON, imageDescriptorFromPlugin(
				PLUGIN_ID, CUSTOM_ICON_PATH_PREFIX2 + "Logger.gif")); //$NON-NLS-1$
		
		registry.put(ISharedImages.LOGGER_FOLDER_ICON, imageDescriptorFromPlugin(
				PLUGIN_ID, CUSTOM_ICON_PATH_PREFIX2 + "LoggerModelFile.gif")); //$NON-NLS-1$
...
//				PLUGIN_ID, CUSTOM_ICON_PATH_PREFIX2 + "RecordedSimulations.gif")); //$NON-NLS-1$
	...
	/**
	 * Log a warning to the ILog for this plugin
	 * 
	 * @param message
