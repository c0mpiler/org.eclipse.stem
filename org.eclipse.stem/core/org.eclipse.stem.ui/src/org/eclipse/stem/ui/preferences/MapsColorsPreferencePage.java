...
public class MapsColorsPreferencePage extends FieldEditorPreferencePage
	...
	/**
	 * ID for the borders alpha field
	 */
	 ...
	 */
	public static final String BACKGROUND_COLOR_DEFAULT_RGB_STRING = "255,255,255"; // Default
	...
	/**
	 * The scale field editor for the borders alpha
	 */
	...
	protected void createFieldEditors() {
		...
		bordersAlphaFieldEditor = new ScaleFieldEditor(BORDERS_ALPHA_ID, 
				"Borders Alpha", getFieldEditorParent(), 0, 255, 1, 10);		
	...
	protected void performDefaults() {
		...
		bordersAlphaFieldEditor.getScaleControl().setSelection(
				BORDERS_ALPHA_DEFAULT_VALUE);
