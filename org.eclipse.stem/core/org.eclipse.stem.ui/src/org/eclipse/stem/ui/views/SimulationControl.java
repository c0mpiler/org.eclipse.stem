...
//		pb.setSelection(current);
	...
	protected void updateTimeLabel(SimulationState state) {
		if(simulationTimeText.isDisposed()) return;
	...
	public void simulationChanged(SimulationEvent event) 
	{
		...
		final SimulationState simulationState = simulation.getSimulationState();
		...
		lastWorkCompleted = workComplete;
		pb.setSelection(workComplete);
			
		updateProgressLabel(workComplete, simulation.getSimulationState());
...
//						return;
//					}
//					if(lastWorkCompleted == workComplete) break;
//					lastWorkCompleted = workComplete;
//					pb.setSelection(workComplete);
//					updateProgressLabel(workComplete, simulation.getSimulationState());
//				}
