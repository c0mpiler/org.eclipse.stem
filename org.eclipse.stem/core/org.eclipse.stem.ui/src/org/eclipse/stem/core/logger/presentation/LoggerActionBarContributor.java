...
/**
 * This is the action bar contributor for the Logger model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoggerActionBarContributor
	 ...
	 * @generated
	 */
	public LoggerActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("logger-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("logger-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CoreEditorPlugin.INSTANCE.getString("_UI_LoggerEditor_menu"), "org.eclipse.stem.core.loggerMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
