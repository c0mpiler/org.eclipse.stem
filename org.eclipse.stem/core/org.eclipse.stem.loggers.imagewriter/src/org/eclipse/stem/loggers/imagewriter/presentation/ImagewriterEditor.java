...
import org.eclipse.stem.loggers.imagewriter.provider.ImagewriterItemProviderAdapterFactory;
...
/**
 * This is an example of a Imagewriter model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImagewriterEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(ImagewriterModelWizard.FILE_EXTENSIONS, "*."); //$NON-NLS-1$
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(ImagewriterEditor.this);
				...
				else if (p == ImagewriterEditor.this) {
					handleActivate();
				}
			}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(ImagewriterEditor.this, false);
			}
			else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "org.eclipse.stem.loggers.imagewriter", //$NON-NLS-1$
					 0,
					 null,
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new ImagewriterItemProviderAdapterFactory());
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), ImagewriterEditor.this) {
						@Override
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					...
					public void setSelectionToViewer(List<?> selection) {
						ImagewriterEditor.this.setSelectionToViewer(selection);
						ImagewriterEditor.this.setFocus();
					}
	...
	public void doSaveAs() {
		...
		String[] files = ImageWriterLoggerEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return ImageWriterLoggerEditPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return ImageWriterLoggerEditPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
