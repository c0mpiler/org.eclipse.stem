...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.definitions.transport.PipeTransportEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PipeTransportEdgeItemProvider
	 ...
	 * @generated
	 */
	public PipeTransportEdgeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PipeTransportEdge.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getTextGen(Object object) {
		URI labelValue = ((PipeTransportEdge)object).getURI();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PipeTransportEdge_type") :
			getString("_UI_PipeTransportEdge_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphPackage.Literals.EDGE__LABEL,
				 TransportFactory.eINSTANCE.createPipeTransportEdgeLabel()));
	}
