...
public class PredicateItemProviderAdapterFactory extends PredicateAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.stem.core.predicate.ModulusTimeTest} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ModulusTimeTestItemProvider modulusTimeTestItemProvider;

	/**
	 * This creates an adapter for a {@link org.eclipse.stem.core.predicate.ModulusTimeTest}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createModulusTimeTestAdapter() {
		if (modulusTimeTestItemProvider == null) {
			modulusTimeTestItemProvider = new ModulusTimeTestItemProvider(this);
		}

		return modulusTimeTestItemProvider;
	}
	...
	public void dispose() {
		...
		if (modulusTimeTestItemProvider != null) modulusTimeTestItemProvider.dispose();
	}
