...
public class PredicateSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PredicatePackage.MODULUS_TIME_TEST: {
				ModulusTimeTest modulusTimeTest = (ModulusTimeTest)theEObject;
				T1 result = caseModulusTimeTest(modulusTimeTest);
				if (result == null) result = caseTimeTest(modulusTimeTest);
				if (result == null) result = caseTest(modulusTimeTest);
				if (result == null) result = casePredicate(modulusTimeTest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Modulus Time Test</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Modulus Time Test</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseModulusTimeTest(ModulusTimeTest object) {
		return null;
	}
