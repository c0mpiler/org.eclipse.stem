	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModifierPackage.DOUBLE_NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(doubleNOPModifier);
			...
			case ModifierPackage.DOUBLE_RANGE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(doubleRangeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.DOUBLE_SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(doubleSequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.FEATURE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(featureModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.INTEGER_NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(integerNOPModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.INTEGER_RANGE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(integerRangeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.INTEGER_SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(integerSequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.LONG_NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(longNOPModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.LONG_RANGE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(longRangeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.LONG_SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(longSequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModifierPackage.NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(nopModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.RANGE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(rangeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STEM_TIME_NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stemTimeNOPModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STEM_TIME_RANGE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stemTimeRangeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STEM_TIME_SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stemTimeSequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(sequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STRING_NOP_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stringNOPModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STRING_SEQUENCE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stringSequenceModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModifierPackage.SINGLE_VALUE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(singleValueModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.DOUBLE_MODIFIER: {
				...
				if (result == null) result = caseModifiable(doubleModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.INTEGER_MODIFIER: {
				...
				if (result == null) result = caseModifiable(integerModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.LONG_MODIFIER: {
				...
				if (result == null) result = caseModifiable(longModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModifierPackage.STEM_TIME_MODIFIER: {
				...
				if (result == null) result = caseModifiable(stemTimeModifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
