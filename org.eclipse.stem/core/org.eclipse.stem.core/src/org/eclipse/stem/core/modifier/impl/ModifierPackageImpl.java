...
public class ModifierPackageImpl extends EPackageImpl implements ModifierPackage {
	...
	public void initializePackageContents() {
		...
		featureModifierEClass.getESuperTypes().add(this.getModifiable());
		...
		op = addEOperation(modifierEClass, null, "resetTarget", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theEcorePackage.getEObject(), "target", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
