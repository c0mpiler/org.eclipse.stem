...
public class PredicatePackageImpl extends EPackageImpl implements PredicatePackage {
	 ...
	 * @generated
	 */
	private EClass modulusTimeTestEClass = null;
	...
	public EAttribute getModulusTimeTest_ModulusDays() {
		return (EAttribute)modulusTimeTestEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getModulusTimeTest_ReferenceTimeValid() {
		return (EAttribute)modulusTimeTestEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getModulusTimeTest_Duration() {
		return (EAttribute)modulusTimeTestEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getModulusTimeTest_ReferenceTime() {
		return (EReference)modulusTimeTestEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getModulusTimeTest_TriggerTime() {
		return (EReference)modulusTimeTestEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		modulusTimeTestEClass = createEClass(MODULUS_TIME_TEST);
		createEAttribute(modulusTimeTestEClass, MODULUS_TIME_TEST__MODULUS_DAYS);
		createEAttribute(modulusTimeTestEClass, MODULUS_TIME_TEST__REFERENCE_TIME_VALID);
		createEAttribute(modulusTimeTestEClass, MODULUS_TIME_TEST__DURATION);
		createEReference(modulusTimeTestEClass, MODULUS_TIME_TEST__REFERENCE_TIME);
		createEReference(modulusTimeTestEClass, MODULUS_TIME_TEST__TRIGGER_TIME);
	}
	...
	public void initializePackageContents() {
		...
		modulusTimeTestEClass.getESuperTypes().add(this.getTimeTest());
		...
		initEClass(modulusTimeTestEClass, ModulusTimeTest.class, "ModulusTimeTest", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getModulusTimeTest_ModulusDays(), theEcorePackage.getEInt(), "modulusDays", "365", 0, 1, ModulusTimeTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getModulusTimeTest_ReferenceTimeValid(), theEcorePackage.getEBoolean(), "referenceTimeValid", null, 0, 1, ModulusTimeTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getModulusTimeTest_Duration(), theEcorePackage.getEInt(), "duration", "1", 0, 1, ModulusTimeTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEReference(getModulusTimeTest_ReferenceTime(), theModelPackage.getSTEMTime(), null, "referenceTime", null, 0, 1, ModulusTimeTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getModulusTimeTest_TriggerTime(), theModelPackage.getSTEMTime(), null, "triggerTime", null, 0, 1, ModulusTimeTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
