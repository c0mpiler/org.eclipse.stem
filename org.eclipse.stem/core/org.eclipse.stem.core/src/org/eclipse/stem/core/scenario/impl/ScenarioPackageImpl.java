...
public class ScenarioPackageImpl extends EPackageImpl implements ScenarioPackage {
	 ...
	 * @generated
	 */
	private EDataType scenarioInitializationExceptionEDataType = null;
	...
	public EDataType getScenarioInitializationException() {
		return scenarioInitializationExceptionEDataType;
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		scenarioInitializationExceptionEDataType = createEDataType(SCENARIO_INITIALIZATION_EXCEPTION);
	}
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(scenarioEClass, ecorePackage.getEBoolean(), "step", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEException(op, theSolverPackage.getSolverException());

		op = addEOperation(scenarioEClass, null, "reset", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEException(op, this.getScenarioInitializationException());

		op = addEOperation(scenarioEClass, null, "initialize", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEException(op, this.getScenarioInitializationException());

		addEOperation(scenarioEClass, ecorePackage.getEString(), "produceTitle", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		// Initialize data types
		initEDataType(scenarioInitializationExceptionEDataType, ScenarioInitializationException.class, "ScenarioInitializationException", !IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
