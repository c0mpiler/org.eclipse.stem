...
public class CommonSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommonPackage.PRIMITIVE_TYPE_OPERATIONS: {
				PrimitiveTypeOperations primitiveTypeOperations = (PrimitiveTypeOperations)theEObject;
				T1 result = casePrimitiveTypeOperations(primitiveTypeOperations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
