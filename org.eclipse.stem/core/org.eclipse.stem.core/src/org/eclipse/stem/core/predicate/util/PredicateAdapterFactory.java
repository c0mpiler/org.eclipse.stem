...
public class PredicateAdapterFactory extends AdapterFactoryImpl {
	...
	protected PredicateSwitch<Adapter> modelSwitch =
		new PredicateSwitch<Adapter>() {
			...
			@Override
			public Adapter caseModulusTimeTest(ModulusTimeTest object) {
				return createModulusTimeTestAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.core.predicate.ModulusTimeTest <em>Modulus Time Test</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
