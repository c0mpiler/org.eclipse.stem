...
public class DecoratorImpl extends IdentifiableImpl implements Decorator {
	...
	public EList<DynamicLabel> getLabelsToUpdate() {
		if (labelsToUpdate == null) {
			labelsToUpdate = new EObjectWithInverseEList<DynamicLabel>(DynamicLabel.class, this, ModelPackage.DECORATOR__LABELS_TO_UPDATE, GraphPackage.DYNAMIC_LABEL__DECORATOR);
		}
