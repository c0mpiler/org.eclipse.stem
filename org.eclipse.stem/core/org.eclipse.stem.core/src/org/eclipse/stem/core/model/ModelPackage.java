...
public interface ModelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INTEGRATION_DECORATOR__ADD_STOCHASTIC_NOISE = NODE_DECORATOR_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTEGRATION_DECORATOR__RANDOM_SEED = NODE_DECORATOR_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int INTEGRATION_DECORATOR__BINOMIAL_DISTRIBUTION = NODE_DECORATOR_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int INTEGRATION_DECORATOR_FEATURE_COUNT = NODE_DECORATOR_FEATURE_COUNT + 3;

	/**
	 * The meta object id for the '{@link org.eclipse.stem.core.model.impl.TransformationDecoratorImpl <em>Transformation Decorator</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.stem.core.model.impl.TransformationDecoratorImpl
	 * @see org.eclipse.stem.core.model.impl.ModelPackageImpl#getTransformationDecorator()
	 * @generated
	 */
	int TRANSFORMATION_DECORATOR = 8;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__URI = NODE_DECORATOR__URI;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__TYPE_URI = NODE_DECORATOR__TYPE_URI;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__DUBLIN_CORE = NODE_DECORATOR__DUBLIN_CORE;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__LABELS_TO_UPDATE = NODE_DECORATOR__LABELS_TO_UPDATE;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__GRAPH = NODE_DECORATOR__GRAPH;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__ENABLED = NODE_DECORATOR__ENABLED;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__GRAPH_DECORATED = NODE_DECORATOR__GRAPH_DECORATED;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__PROGRESS = NODE_DECORATOR__PROGRESS;
	 ...
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR__SOURCE_LABELS = NODE_DECORATOR_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Transformation Decorator</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRANSFORMATION_DECORATOR_FEATURE_COUNT = NODE_DECORATOR_FEATURE_COUNT + 1;

	/**
	 * The meta object id for the '<em>Binomial Distribution Util</em>' data type.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.stem.core.math.BinomialDistributionUtil
	 * @see org.eclipse.stem.core.model.impl.ModelPackageImpl#getBinomialDistributionUtil()
	 * @generated
	 */
	int BINOMIAL_DISTRIBUTION_UTIL = 9;
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.stem.core.model.IntegrationDecorator#isAddStochasticNoise <em>Add Stochastic Noise</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Add Stochastic Noise</em>'.
	 * @see org.eclipse.stem.core.model.IntegrationDecorator#isAddStochasticNoise()
	 * @see #getIntegrationDecorator()
	 * @generated
	 */
	EAttribute getIntegrationDecorator_AddStochasticNoise();

	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.stem.core.model.IntegrationDecorator#getRandomSeed <em>Random Seed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Random Seed</em>'.
	 * @see org.eclipse.stem.core.model.IntegrationDecorator#getRandomSeed()
	 * @see #getIntegrationDecorator()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.stem.core.model.IntegrationDecorator#getBinomialDistribution <em>Binomial Distribution</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Binomial Distribution</em>'.
	 * @see org.eclipse.stem.core.model.IntegrationDecorator#getBinomialDistribution()
	 * @see #getIntegrationDecorator()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.stem.core.model.TransformationDecorator <em>Transformation Decorator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Transformation Decorator</em>'.
	...
	/**
	 * Returns the meta object for the reference list '{@link org.eclipse.stem.core.model.TransformationDecorator#getSourceLabels <em>Source Labels</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Source Labels</em>'.
	 * @see org.eclipse.stem.core.model.TransformationDecorator#getSourceLabels()
	 * @see #getTransformationDecorator()
	 * @generated
	 */
	EReference getTransformationDecorator_SourceLabels();

	/**
	 * Returns the meta object for data type '{@link org.eclipse.stem.core.math.BinomialDistributionUtil <em>Binomial Distribution Util</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for data type '<em>Binomial Distribution Util</em>'.
	 * @see org.eclipse.stem.core.math.BinomialDistributionUtil
	 * @model instanceClass="org.eclipse.stem.core.math.BinomialDistributionUtil" serializeable="false"
	 * @generated
	 */
	...
	interface Literals  {
		...
		/**
		 * The meta object literal for the '<em><b>Add Stochastic Noise</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute INTEGRATION_DECORATOR__ADD_STOCHASTIC_NOISE = eINSTANCE.getIntegrationDecorator_AddStochasticNoise();
		 ...
		 * @generated
		 */
		EAttribute INTEGRATION_DECORATOR__RANDOM_SEED = eINSTANCE.getIntegrationDecorator_RandomSeed();

		/**
		 * The meta object literal for the '<em><b>Binomial Distribution</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute INTEGRATION_DECORATOR__BINOMIAL_DISTRIBUTION = eINSTANCE.getIntegrationDecorator_BinomialDistribution();

		/**
		 * The meta object literal for the '{@link org.eclipse.stem.core.model.impl.TransformationDecoratorImpl <em>Transformation Decorator</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.stem.core.model.impl.TransformationDecoratorImpl
		 * @see org.eclipse.stem.core.model.impl.ModelPackageImpl#getTransformationDecorator()
		 * @generated
		 */
		EClass TRANSFORMATION_DECORATOR = eINSTANCE.getTransformationDecorator();

		/**
		 * The meta object literal for the '<em><b>Source Labels</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference TRANSFORMATION_DECORATOR__SOURCE_LABELS = eINSTANCE.getTransformationDecorator_SourceLabels();

		/**
		 * The meta object literal for the '<em>Binomial Distribution Util</em>' data type.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.stem.core.math.BinomialDistributionUtil
		 * @see org.eclipse.stem.core.model.impl.ModelPackageImpl#getBinomialDistributionUtil()
		 * @generated
		 */
		EDataType BINOMIAL_DISTRIBUTION_UTIL = eINSTANCE.getBinomialDistributionUtil();
