...
public class TriggerAdapterFactory extends AdapterFactoryImpl {
	...
	protected TriggerSwitch<Adapter> modelSwitch =
		new TriggerSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTriggerList(TriggerList object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.core.trigger.TriggerList <em>List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
