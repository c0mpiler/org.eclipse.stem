...
public class TriggerSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TriggerPackage.TRIGGER_LIST: {
				TriggerList triggerList = (TriggerList)theEObject;
				T1 result = caseTriggerList(triggerList);
				if (result == null) result = caseDecorator(triggerList);
				if (result == null) result = caseIdentifiable(triggerList);
				if (result == null) result = caseComparable(triggerList);
				if (result == null) result = caseSanityChecker(triggerList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T1 caseTriggerList(TriggerList object) {
		return null;
	}
