	...
	protected void addUseAbsoluteValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MigrationEdgeGraphGenerator_useAbsoluteValues_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MigrationEdgeGraphGenerator_useAbsoluteValues_feature", "_UI_MigrationEdgeGraphGenerator_type"),
				 GraphgeneratorsPackage.Literals.MIGRATION_EDGE_GRAPH_GENERATOR__USE_ABSOLUTE_VALUES,
				 true,
				 false,
				 false,
