 ...
 *   <li>{@link org.eclipse.stem.graphgenerators.impl.MigrationEdgeGraphGeneratorImpl#isUseAbsoluteValues <em>Use Absolute Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MigrationEdgeGraphGeneratorImpl extends GraphGeneratorImpl implements MigrationEdgeGraphGenerator {
	...
	public Graph getGraph() {
		...
		while((iter!=null)&&(iter.hasNext())){
				...
				mEdge2.setUseAbsoluteValues(this.useAbsoluteValues);
	...
	public void setUseAbsoluteValues(boolean newUseAbsoluteValues) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphgeneratorsPackage.MIGRATION_EDGE_GRAPH_GENERATOR__USE_ABSOLUTE_VALUES, oldUseAbsoluteValues, useAbsoluteValues));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GraphgeneratorsPackage.MIGRATION_EDGE_GRAPH_GENERATOR__USE_ABSOLUTE_VALUES:
