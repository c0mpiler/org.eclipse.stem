...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gragg Bulirsch Stoer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.GraggBulirschStoerImpl#getRelativeTolerance <em>Relative Tolerance</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.GraggBulirschStoerImpl#getAbsoluteTolerance <em>Absolute Tolerance</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.GraggBulirschStoerImpl#getMinStep <em>Min Step</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.GraggBulirschStoerImpl#getMaxStep <em>Max Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GraggBulirschStoerImpl extends ApacheCommonsMathODESolverImpl implements GraggBulirschStoer {
	 ...
	 * @generated NOT
	 */
	public GraggBulirschStoerImpl() {
		super();
	}
	
	/**
	 * Create a new GraggBulirschStoerIntegrator
	 * 
	 * @return FirstOrderIntergrator  New GraggBulirschStoerIntegrator 
	 * @generated NOT
	 */
	...
	public void setRelativeTolerance(double newRelativeTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.GRAGG_BULIRSCH_STOER__RELATIVE_TOLERANCE, oldRelativeTolerance, relativeTolerance));
	}
	...
	public void setAbsoluteTolerance(double newAbsoluteTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.GRAGG_BULIRSCH_STOER__ABSOLUTE_TOLERANCE, oldAbsoluteTolerance, absoluteTolerance));
	}
	...
	public void setMinStep(double newMinStep) {
		...
		minStep = newMinStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.GRAGG_BULIRSCH_STOER__MIN_STEP, oldMinStep, minStep));
	}
	...
	public void setMaxStep(double newMaxStep) {
		...
		maxStep = newMaxStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.GRAGG_BULIRSCH_STOER__MAX_STEP, oldMaxStep, maxStep));
	}
