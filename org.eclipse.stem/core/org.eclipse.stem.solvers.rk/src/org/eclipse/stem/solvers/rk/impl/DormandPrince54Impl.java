...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dormand Prince54</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.DormandPrince54Impl#getRelativeTolerance <em>Relative Tolerance</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.DormandPrince54Impl#getAbsoluteTolerance <em>Absolute Tolerance</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.DormandPrince54Impl#getMinStep <em>Min Step</em>}</li>
 *   <li>{@link org.eclipse.stem.solvers.rk.impl.DormandPrince54Impl#getMaxStep <em>Max Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DormandPrince54Impl extends ApacheCommonsMathODESolverImpl implements DormandPrince54 {
	/**
	...
	protected EClass eStaticClass() {
		return RkPackage.Literals.DORMAND_PRINCE54;
	}
	...
	public FirstOrderIntegrator createIntegrator() {
		FirstOrderIntegrator dp54 = new DormandPrince54Integrator(this.getMinStep(), this.getMaxStep(), this.getAbsoluteTolerance(), this.getRelativeTolerance());
		return dp54;
	}
	...
	public void setRelativeTolerance(double newRelativeTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.DORMAND_PRINCE54__RELATIVE_TOLERANCE, oldRelativeTolerance, relativeTolerance));
	}
	...
	public void setAbsoluteTolerance(double newAbsoluteTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.DORMAND_PRINCE54__ABSOLUTE_TOLERANCE, oldAbsoluteTolerance, absoluteTolerance));
	}
	...
	public void setMinStep(double newMinStep) {
		...
		minStep = newMinStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.DORMAND_PRINCE54__MIN_STEP, oldMinStep, minStep));
	}
	...
	public void setMaxStep(double newMaxStep) {
		...
		maxStep = newMaxStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RkPackage.DORMAND_PRINCE54__MAX_STEP, oldMaxStep, maxStep));
	}
