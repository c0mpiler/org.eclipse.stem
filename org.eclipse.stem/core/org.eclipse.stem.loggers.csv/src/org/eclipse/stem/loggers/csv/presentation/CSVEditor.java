...
import org.eclipse.stem.loggers.csv.provider.CSVItemProviderAdapterFactory;
...
/**
 * This is an example of a CSV model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CSVEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(CSVModelWizard.FILE_EXTENSIONS, "*."); //$NON-NLS-1$
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(CSVEditor.this);
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(CSVEditor.this, false);
			}
			else {
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), CSVEditor.this) {
						@Override
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					...
					public void setSelectionToViewer(List<?> selection) {
						CSVEditor.this.setSelectionToViewer(selection);
						CSVEditor.this.setFocus();
					}
	...
	public void doSaveAs() {
		...
		String[] files = CSVLoggerEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return CSVLoggerEditPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return CSVLoggerEditPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
