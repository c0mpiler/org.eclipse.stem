...
public class CSVAdapterFactory extends AdapterFactoryImpl {
	...
	protected CSVSwitch<Adapter> modelSwitch =
		new CSVSwitch<Adapter>() {
			@Override
			public Adapter caseCSVLogger(CSVLogger object) {
				return createCSVLoggerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.loggers.csv.CSVLogger <em>Logger</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCSVLoggerAdapter() {
		return null;
	}
