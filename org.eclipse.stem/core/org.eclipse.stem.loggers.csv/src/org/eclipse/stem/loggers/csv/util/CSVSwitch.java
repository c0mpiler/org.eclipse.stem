 ...
 *******************************************************************************/
package org.eclipse.stem.loggers.csv.util;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.stem.loggers.csv.CSVPackage
 * @generated
 */
public class CSVSwitch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CSVPackage.CSV_LOGGER: {
				CSVLogger csvLogger = (CSVLogger)theEObject;
				T1 result = caseCSVLogger(csvLogger);
				if (result == null) result = caseSynchronousDecoratorPropertyLogger(csvLogger);
				if (result == null) result = caseSynchronousLogger(csvLogger);
				if (result == null) result = caseSimulationLogger(csvLogger);
				if (result == null) result = caseLogger(csvLogger);
				if (result == null) result = caseIdentifiable(csvLogger);
				if (result == null) result = caseComparable(csvLogger);
				if (result == null) result = caseSanityChecker(csvLogger);
	 ...
	 * @generated
	 */
	public T1 caseCSVLogger(CSVLogger object) {
		return null;
	}
