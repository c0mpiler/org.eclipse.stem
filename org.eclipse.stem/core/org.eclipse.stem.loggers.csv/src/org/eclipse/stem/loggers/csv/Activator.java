...
import org.eclipse.stem.ui.wizards.CSVLoggerPropertyEditorAdapterFactory;
import org.eclipse.stem.ui.wizards.CSVLoggerPropertyStringProviderAdapterFactory;
...
public class Activator extends Plugin {
	 ...
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "org.eclipse.stem.loggers.csv"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		new CSVLoggerPropertyEditorAdapterFactory();
		new CSVLoggerPropertyStringProviderAdapterFactory();
	} // start
