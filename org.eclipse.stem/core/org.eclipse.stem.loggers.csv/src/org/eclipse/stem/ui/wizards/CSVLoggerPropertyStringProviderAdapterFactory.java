 ...
 */
public class CSVLoggerPropertyStringProviderAdapterFactory extends
		CSVAdapterFactory implements PropertyStringProviderAdapterFactory {
	...
	public Adapter createLoggerAdapter() {
		...
		if (adapter == null) {
			// No
			adapter = new CSVLoggerPropertyStringProviderAdapter();
	 ...
	 */
	public static class CSVLoggerPropertyStringProviderAdapter extends
		...
		public String getPropertyName(IItemPropertyDescriptor descriptor) {
			return CSVLoggerWizardMessages
		...
		public String getPropertyToolTip(
			...
			final EStructuralFeature feature = (EStructuralFeature) descriptor
					.getFeature(null);
			return CSVLoggerWizardMessages.getString(feature.getName()
					+ TT_SUFFIX);
		} // getPropertyToolTip
