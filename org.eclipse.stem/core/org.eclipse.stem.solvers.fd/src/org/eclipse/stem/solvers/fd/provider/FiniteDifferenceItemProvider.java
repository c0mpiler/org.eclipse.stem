...
public class FiniteDifferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FiniteDifference_minStep_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FiniteDifference_minStep_feature", "_UI_FiniteDifference_type"),
				 FdPackage.Literals.FINITE_DIFFERENCE__MIN_STEP,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String txt = super.getText(object);
		return txt;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FiniteDifference.class)) {
