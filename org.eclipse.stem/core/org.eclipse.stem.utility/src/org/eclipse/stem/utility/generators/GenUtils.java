...
public class GenUtils {
	...
	static protected List<ISOCode2> getSortedDescriptors(List<String> list) {
		...
		Iterator it = list.iterator();
		while (it.hasNext()) {
			UtilLogger.logInformation("Descriptor -> " + it.next()); //$NON-NLS-1$
	...
	static protected String getCopyright() {
		...
		String copyright = "# /*********************************************************************************************\n"; //$NON-NLS-1$
		copyright += "# * Copyright (c) 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018";//$NON-NLS-1$
		copyright += "* IBM Corporation, BfR, and others.\n"; //$NON-NLS-1$
