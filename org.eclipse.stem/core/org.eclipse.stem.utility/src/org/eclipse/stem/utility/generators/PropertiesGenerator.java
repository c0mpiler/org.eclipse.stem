...
public class PropertiesGenerator {
	...
	public static void main(String[] args) {
		...
		// UtilLogger.logInformation("\t\t CIA data"); //$NON-NLS-1$
		...
		// //$NON-NLS-1$$
		// UtilLogger.logInformation("\t\t Output directory for properties files");
		// //$NON-NLS-1$
		// UtilLogger.logInformation("\t\t Output directory for GML maps");
		// //$NON-NLS-1$
		// return;
		// }
