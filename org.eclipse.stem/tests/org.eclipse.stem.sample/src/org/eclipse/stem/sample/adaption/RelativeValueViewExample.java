...
public class RelativeValueViewExample extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		simulationColumn.addSelectionListener(new SelectionAdapter() {
			...
			SelectionEvent e) {
				((RelativeValueViewSorter) treeViewer.getComparator()).doSort(0);
		...
		decoratorColumn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(@SuppressWarnings("unused")
			SelectionEvent e) {
				((RelativeValueViewSorter) treeViewer.getComparator()).doSort(1);
				treeViewer.refresh(true);
			}
		});
		...
		nodeColumn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(@SuppressWarnings("unused")
			SelectionEvent e) {
				((RelativeValueViewSorter) treeViewer.getComparator()).doSort(2);
				treeViewer.refresh(true);
			}
		});
		...
		currentValueColumn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(@SuppressWarnings("unused")
			SelectionEvent e) {
				((RelativeValueViewSorter) treeViewer.getComparator()).doSort(3);
				treeViewer.refresh(true);
			}
		});
		...
		currentValueColumn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(@SuppressWarnings("unused")
			SelectionEvent e) {
				((RelativeValueViewSorter) treeViewer.getComparator()).doSort(4);
				treeViewer.refresh(true);
			}
		});
		...
		treeViewer.setComparator(new RelativeValueViewSorter());
	 ...
	 */
	public static class RelativeValueViewSorter extends ViewerComparator {
