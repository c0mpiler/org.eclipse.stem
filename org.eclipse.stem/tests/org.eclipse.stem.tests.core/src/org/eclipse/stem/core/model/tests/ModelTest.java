 ...
 *   <li>{@link org.eclipse.stem.core.model.Model#getCanonicalGraphNoDecorate(org.eclipse.emf.common.util.URI, org.eclipse.stem.core.common.IdentifiableFilter, org.eclipse.stem.core.model.STEMTime) <em>Get Canonical Graph No Decorate</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
...
//		g4.putNodeLabel((NodeLabel) n4d.getLabels().get(0));
	...
	/**
	 * Tests the '{@link org.eclipse.stem.core.model.Model#getCanonicalGraphNoDecorate(org.eclipse.emf.common.util.URI, org.eclipse.stem.core.common.IdentifiableFilter, org.eclipse.stem.core.model.STEMTime) <em>Get Canonical Graph No Decorate</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.stem.core.model.Model#getCanonicalGraphNoDecorate(org.eclipse.emf.common.util.URI, org.eclipse.stem.core.common.IdentifiableFilter, org.eclipse.stem.core.model.STEMTime)
	 * @generated
	 */
	public void testGetCanonicalGraphNoDecorate__URI_IdentifiableFilter_STEMTime() {
	...
	public void testGetCanonicalGraph__URI() {
		...
		try {
			canonicalGraph = model.getCanonicalGraph(CANONICAL_GRAPH1_URI, null, time);
		} catch(ScenarioInitializationException se) {
			fail(se.getErrorMessage());
		}
	...
	public void testNonDestructiveGetCanonicalGraph() {
		...
		try {
			graph1 = model.getCanonicalGraph(CANONICAL_GRAPH1_URI, new IdentifiableFilterImpl(model.getDublinCore().getCoverage()), now);
			graph2 = model.getCanonicalGraph(CANONICAL_GRAPH2_URI, new IdentifiableFilterImpl(model.getDublinCore().getCoverage()), now);
		} catch(ScenarioInitializationException se) {
			fail(se.getErrorMessage());
		}
	...
	public void testGetUnresolvedCanonicalGraph() {
		...
		Graph canonicalGraph = null;
		try {
			canonicalGraph = model.getCanonicalGraph(CANONICAL_GRAPH1_URI, new IdentifiableFilterImpl(model.getDublinCore().getCoverage()), now);
		} catch(ScenarioInitializationException se) {
			fail(se.getErrorMessage());
		}
