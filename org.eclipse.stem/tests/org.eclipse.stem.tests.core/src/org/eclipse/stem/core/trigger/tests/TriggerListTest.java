 ...
 * @generated
 */
public class TriggerListTest extends DecoratorTest {
	...
	public static void main(String[] args) {
		TestRunner.run(TriggerListTest.class);
	}
	 ...
	 * @generated
	 */
	public TriggerListTest(String name) {
		super(name);
	}
	 ...
	 */
	@Override
	protected TriggerList getFixture() {
		return (TriggerList)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(TriggerFactory.eINSTANCE.createTriggerList());
	}
