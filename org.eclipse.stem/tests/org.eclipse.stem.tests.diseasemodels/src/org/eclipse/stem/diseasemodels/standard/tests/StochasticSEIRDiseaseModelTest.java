...
public class StochasticSEIRDiseaseModelTest extends SEIRTest {
	...
	public static StochasticSEIRDiseaseModel createFixture(double newGain) {
		StochasticSEIRDiseaseModel diseaseModel = StandardFactory.eINSTANCE.createStochasticSEIRDiseaseModel();
		diseaseModel.setDiseaseName(TEST_SEIR_DISEASE_NAME);
		diseaseModel.getDublinCore().setTitle(TEST_SEIR_DISEASE_NAME);
