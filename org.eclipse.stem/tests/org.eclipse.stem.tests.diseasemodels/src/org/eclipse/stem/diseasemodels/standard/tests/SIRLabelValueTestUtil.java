						...
						for(double births : values){
							for(double deaths : values){
								for(double diseaseDeaths : values){
									...
									SIRLabelValueTest labelValueTest = new SIRLabelValueTest("SIRLabelValueTest");
									SIRLabelValueImpl labelValue = (SIRLabelValueImpl)labelValueTest.getFixture();
									labelValue.setS(s);
									labelValue.setI(s);
									labelValue.setR(s);
									labelValue.setDiseaseDeaths(diseaseDeaths);
									assertTrue("The SIRLabelValue: " + labelValue + " is insane!", labelValue.sane());
									// put the value in a label
									SIRLabelTest labelTest = new SIRLabelTest("SIRLabelTest");
									SIRLabelImpl label = (SIRLabelImpl)labelTest.getFixture();
