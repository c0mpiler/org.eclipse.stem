						...
						for(double births : values){
							for(double deaths : values){
								for(double diseaseDeaths : values){
									...
									SILabelValueTest labelValueTest = new SILabelValueTest("SEIRLabelValueTest");
									SILabelValueImpl labelValue = (SILabelValueImpl)labelValueTest.getFixture();
									labelValue.setS(s);
									labelValue.setI(s);
									labelValue.setDiseaseDeaths(diseaseDeaths);
									assertTrue("The SILabelValue: " + labelValue + " is insane!", labelValue.sane());
									// put the value in a label
									SILabelTest labelTest = new SILabelTest("SEIRLabelTest");
									SILabelImpl label = (SILabelImpl)labelTest.getFixture();
