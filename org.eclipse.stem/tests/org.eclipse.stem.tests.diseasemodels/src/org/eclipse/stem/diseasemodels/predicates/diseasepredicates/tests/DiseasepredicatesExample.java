...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>diseasepredicates</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DiseasepredicatesExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DiseasepredicatesPackage.eNS_URI, 
			 DiseasepredicatesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.diseasepredicates")); //$NON-NLS-1$
				LabelValueTest root = DiseasepredicatesFactory.eINSTANCE.createLabelValueTest();
