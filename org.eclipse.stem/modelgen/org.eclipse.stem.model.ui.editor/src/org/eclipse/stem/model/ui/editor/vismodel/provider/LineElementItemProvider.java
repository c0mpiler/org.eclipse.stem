...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.model.ui.editor.vismodel.LineElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LineElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LineElement_style_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LineElement_style_feature", "_UI_LineElement_type"),
				 VisualMetamodelPackage.Literals.LINE_ELEMENT__STYLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_LineElement_type") + " " + lineElement.getStyle();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LineElement.class)) {
			case VisualMetamodelPackage.LINE_ELEMENT__STYLE:
