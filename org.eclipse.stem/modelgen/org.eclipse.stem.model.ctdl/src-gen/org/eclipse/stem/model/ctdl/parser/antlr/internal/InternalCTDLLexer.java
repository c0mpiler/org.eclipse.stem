...
public class InternalCTDLLexer extends Lexer {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
                        ...
                        switch (alt12) {
                    	case 1 :
                    	    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // ../org.eclipse.stem.model.ctdl/src-gen/org/eclipse/stem/model/ctdl/parser/antlr/internal/InternalCTDL.g:852:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
