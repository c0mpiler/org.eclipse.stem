...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.model.metamodel.Compartment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.COMPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Compartment_dataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Compartment_dataType_feature", "_UI_Compartment_type"),
				 MetamodelPackage.Literals.COMPARTMENT__DATA_TYPE,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Compartment_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Compartment_type_feature", "_UI_Compartment_type"),
				 MetamodelPackage.Literals.COMPARTMENT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
