...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.model.metamodel.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addModelTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_modelType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_modelType_feature", "_UI_Model_type"),
				 MetamodelPackage.Literals.MODEL__MODEL_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_class_feature", "_UI_Model_type"),
				 MetamodelPackage.Literals.MODEL__CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParentModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_parentModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_parentModel_feature", "_UI_Model_type"),
				 MetamodelPackage.Literals.MODEL__PARENT_MODEL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.MODEL__AUTHOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.MODEL__PARAMETERS,
				 MetamodelFactory.eINSTANCE.createModelParam()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.MODEL__GENERATOR_SETTINGS,
				 MetamodelFactory.eINSTANCE.createModelGenSettings()));
	}
