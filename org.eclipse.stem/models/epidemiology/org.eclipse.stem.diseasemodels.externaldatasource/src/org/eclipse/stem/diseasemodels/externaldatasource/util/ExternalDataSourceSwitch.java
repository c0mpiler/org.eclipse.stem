	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExternalDataSourcePackage.EXTERNAL_DATA_SOURCE_DISEASE_MODEL: {
				...
				if (result == null) result = caseStandardDiseaseModel(externalDataSourceDiseaseModel);
				if (result == null) result = caseDiseaseModel(externalDataSourceDiseaseModel);
				if (result == null) result = caseIntegrationDecorator(externalDataSourceDiseaseModel);
