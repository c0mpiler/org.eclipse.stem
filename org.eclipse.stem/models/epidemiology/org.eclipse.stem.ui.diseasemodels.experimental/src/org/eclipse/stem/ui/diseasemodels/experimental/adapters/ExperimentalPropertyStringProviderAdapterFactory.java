 ...
 */
public class ExperimentalPropertyStringProviderAdapterFactory extends
	...
	public Adapter createPercolationDiseaseModelAdapter() {
		...
		if (adapter == null) {
			// No
			adapter = new  ExperimentalPropertyStringProviderAdapter();
	...
	public static class ExperimentalPropertyStringProviderAdapter extends StandardPropertyStringProviderAdapterFactory.StandardPropertyStringProviderAdapter {
		...
		public String getPropertyName(IItemPropertyDescriptor descriptor) {
			try {
				return ExperimentalDiseaseWizardMessages
		...
		public String getPropertyToolTip(
			...
			try {
				final EStructuralFeature feature = (EStructuralFeature) descriptor
						.getFeature(null);
				return ExperimentalDiseaseWizardMessages.getString(feature
						.getName()
						+ TT_SUFFIX);
			} catch (MissingResourceException e) {
