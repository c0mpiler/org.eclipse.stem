	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ForcingPackage.GAUSSIAN2_FORCING_DISEASE_MODEL: {
				...
				if (result == null) result = caseGaussianForcingDiseaseModel(gaussian2ForcingDiseaseModel);
			...
			case ForcingPackage.GAUSSIAN3_FORCING_DISEASE_MODEL: {
				...
				if (result == null) result = caseGaussianForcingDiseaseModel(gaussian3ForcingDiseaseModel);
