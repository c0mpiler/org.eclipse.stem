...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>poliodiseasemodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PolioExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(PolioPackage.eNS_URI, 
			 PolioPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.polio")); //$NON-NLS-1$
				OralPolioVaccineModel root = PolioFactory.eINSTANCE.createOralPolioVaccineModel();
