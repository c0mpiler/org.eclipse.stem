 ...
 * @generated
 */
public class PolioAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected PolioSwitch<Adapter> modelSwitch =
		new PolioSwitch<Adapter>() {
			@Override
			public Adapter caseOralPolioVaccineModel(OralPolioVaccineModel object) {
				return createOralPolioVaccineModelAdapter();
			}
			@Override
			public Adapter caseOpvLabel(OpvLabel object) {
				return createOpvLabelAdapter();
			}
			@Override
			public Adapter caseOpvLabelValue(OpvLabelValue object) {
				return createOpvLabelValueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.poliodiseasemodel.OralPolioVaccineModel <em>Oral Polio Vaccine Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.poliodiseasemodel.OpvLabel <em>Opv Label</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.poliodiseasemodel.OpvLabelValue <em>Opv Label Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
