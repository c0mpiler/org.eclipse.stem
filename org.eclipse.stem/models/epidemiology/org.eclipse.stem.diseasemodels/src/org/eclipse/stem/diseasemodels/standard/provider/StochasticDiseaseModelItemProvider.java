...
public class StochasticDiseaseModelItemProvider
	...
	public String getText(Object object) {
		StochasticDiseaseModel stochasticDiseaseModel = (StochasticDiseaseModel)object;
		return getString("_UI_StochasticDiseaseModel_type") + " " + stochasticDiseaseModel.getSeed(); //$NON-NLS-1$ //$NON-NLS-2$
	}
