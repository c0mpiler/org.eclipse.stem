 ...
 * @generated
 */
public class DiseasepredicatesSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public DiseasepredicatesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DiseasepredicatesPackage.LABEL_VALUE_TEST: {
				LabelValueTest labelValueTest = (LabelValueTest)theEObject;
				T result = caseLabelValueTest(labelValueTest);
	 ...
	 * @generated
	 */
	public T caseLabelValueTest(LabelValueTest object) {
		return null;
	}
