...
public class StandardAdapterFactory extends AdapterFactoryImpl {
	...
	protected StandardSwitch<Adapter> modelSwitch =
		new StandardSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStandardDiseaseInitializer(StandardDiseaseInitializer object) {
				return createStandardDiseaseInitializerAdapter();
			}
			@Override
			public Adapter caseDiseaseInitializer(DiseaseInitializer object) {
				return createDiseaseInitializerAdapter();
			}
			@Override
			public Adapter caseExternalDataSourceDiseaseInitializer(ExternalDataSourceDiseaseInitializer object) {
				return createExternalDataSourceDiseaseInitializerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.standard.StandardDiseaseInitializer <em>Disease Initializer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.standard.DiseaseInitializer <em>Disease Initializer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.diseasemodels.standard.ExternalDataSourceDiseaseInitializer <em>External Data Source Disease Initializer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
