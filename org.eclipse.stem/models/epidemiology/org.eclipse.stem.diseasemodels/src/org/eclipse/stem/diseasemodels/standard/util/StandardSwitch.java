...
public class StandardSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StandardPackage.DISEASE_MODEL: {
				...
				if (result == null) result = caseIntegrationDecorator(diseaseModel);
			...
			case StandardPackage.DISEASE_MODEL_LABEL: {
				...
				if (result == null) result = caseIntegrationLabel(diseaseModelLabel);
				...
				if (result == null) result = caseSanityChecker(diseaseModelLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.DISEASE_MODEL_LABEL_VALUE: {
				...
				if (result == null) result = casePrimitiveTypeOperations(diseaseModelLabelValue);
				if (result == null) result = caseSanityChecker(diseaseModelLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.INFECTOR: {
				...
				if (result == null) result = caseSanityChecker(infector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.SEIR_LABEL: {
				...
				if (result == null) result = caseSanityChecker(seirLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.SEIR_LABEL_VALUE: {
				...
				if (result == null) result = casePrimitiveTypeOperations(seirLabelValue);
				if (result == null) result = caseSanityChecker(seirLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.SI_INFECTOR: {
				...
				if (result == null) result = caseSanityChecker(siInfector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.SI_LABEL: {
				...
				if (result == null) result = caseSanityChecker(siLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.SI_LABEL_VALUE: {
				...
				if (result == null) result = casePrimitiveTypeOperations(siLabelValue);
				if (result == null) result = caseSanityChecker(siLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.SIR_LABEL: {
				...
				if (result == null) result = caseSanityChecker(sirLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.SIR_LABEL_VALUE: {
				...
				if (result == null) result = casePrimitiveTypeOperations(sirLabelValue);
				if (result == null) result = caseSanityChecker(sirLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.STANDARD_DISEASE_MODEL_LABEL: {
				...
				if (result == null) result = caseSanityChecker(standardDiseaseModelLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.STANDARD_DISEASE_MODEL_LABEL_VALUE: {
				...
				if (result == null) result = casePrimitiveTypeOperations(standardDiseaseModelLabelValue);
				if (result == null) result = caseSanityChecker(standardDiseaseModelLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.STANDARD_INFECTOR: {
				...
				if (result == null) result = caseSanityChecker(standardInfector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.SIR_INOCULATOR: {
				...
				if (result == null) result = caseSanityChecker(sirInoculator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StandardPackage.INFECTOR_INOCULATOR_COLLECTION: {
				...
				if (result == null) result = caseSanityChecker(infectorInoculatorCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.STANDARD_DISEASE_INITIALIZER: {
				StandardDiseaseInitializer standardDiseaseInitializer = (StandardDiseaseInitializer)theEObject;
				T1 result = caseStandardDiseaseInitializer(standardDiseaseInitializer);
				if (result == null) result = caseDiseaseInitializer(standardDiseaseInitializer);
				if (result == null) result = caseNodeDecorator(standardDiseaseInitializer);
				if (result == null) result = caseDecorator(standardDiseaseInitializer);
				if (result == null) result = caseIdentifiable(standardDiseaseInitializer);
				if (result == null) result = caseComparable(standardDiseaseInitializer);
				if (result == null) result = caseSanityChecker(standardDiseaseInitializer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.DISEASE_INITIALIZER: {
				DiseaseInitializer diseaseInitializer = (DiseaseInitializer)theEObject;
				T1 result = caseDiseaseInitializer(diseaseInitializer);
				if (result == null) result = caseNodeDecorator(diseaseInitializer);
				if (result == null) result = caseDecorator(diseaseInitializer);
				if (result == null) result = caseIdentifiable(diseaseInitializer);
				if (result == null) result = caseComparable(diseaseInitializer);
				if (result == null) result = caseSanityChecker(diseaseInitializer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StandardPackage.EXTERNAL_DATA_SOURCE_DISEASE_INITIALIZER: {
				ExternalDataSourceDiseaseInitializer externalDataSourceDiseaseInitializer = (ExternalDataSourceDiseaseInitializer)theEObject;
				T1 result = caseExternalDataSourceDiseaseInitializer(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseDiseaseInitializer(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseNodeDecorator(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseDecorator(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseIdentifiable(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseComparable(externalDataSourceDiseaseInitializer);
				if (result == null) result = caseSanityChecker(externalDataSourceDiseaseInitializer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Disease Initializer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Disease Initializer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseStandardDiseaseInitializer(StandardDiseaseInitializer object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseDiseaseInitializer(DiseaseInitializer object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>External Data Source Disease Initializer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>External Data Source Disease Initializer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseExternalDataSourceDiseaseInitializer(ExternalDataSourceDiseaseInitializer object) {
		return null;
	}
