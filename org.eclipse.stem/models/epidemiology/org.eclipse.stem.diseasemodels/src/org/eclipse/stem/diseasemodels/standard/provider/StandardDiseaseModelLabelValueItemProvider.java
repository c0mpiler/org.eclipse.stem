...
public class StandardDiseaseModelLabelValueItemProvider extends
	...
	protected void addIncidencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StandardDiseaseModelLabelValue_incidence_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StandardDiseaseModelLabelValue_incidence_feature", "_UI_StandardDiseaseModelLabelValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 StandardPackage.Literals.STANDARD_DISEASE_MODEL_LABEL_VALUE__INCIDENCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addDiseaseDeathsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StandardDiseaseModelLabelValue_diseaseDeaths_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StandardDiseaseModelLabelValue_diseaseDeaths_feature", "_UI_StandardDiseaseModelLabelValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 StandardPackage.Literals.STANDARD_DISEASE_MODEL_LABEL_VALUE__DISEASE_DEATHS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_StandardDiseaseModelLabelValue_type") + " " + standardDiseaseModelLabelValue.getPopulationCount(); //$NON-NLS-1$ //$NON-NLS-2$
	}
