...
abstract public class DiseaseModelPropertyEditor extends GenericPropertyEditor {
	...
	public boolean isUserSpecifiedProperty(final EStructuralFeature feature) {
		...
		if (containingClass.equals(ModelPackage.eINSTANCE.getIntegrationDecorator()) 
				...
				|| containingClass.equals(StandardPackage.eINSTANCE.getStochasticDiseaseModel())
				|| containingClass.getEAllSuperTypes().contains(StandardPackage.eINSTANCE.getDiseaseModel())
				|| containingClass.getEAllSuperTypes().contains(StandardPackage.eINSTANCE.getStochasticDiseaseModel())) {
	...
	public void populate(DiseaseModel diseaseModel) {
		super.populate(diseaseModel); // Random seed etc.
