package org.eclipse.stem.diseasemodels.predicates.diseasepredicates.presentation;
 ...
 * @generated
 */
public class DiseasepredicatesModelWizard extends Wizard implements INewWizard {
	/**
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(DiseasemodelsEditorPlugin.INSTANCE.getString("_UI_DiseasepredicatesEditorFilenameExtensions").split("\\s*,\\s*"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		DiseasemodelsEditorPlugin.INSTANCE.getString("_UI_DiseasepredicatesEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", "); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 ...
	 * @generated
	 */
	protected DiseasepredicatesPackage diseasepredicatesPackage = DiseasepredicatesPackage.eINSTANCE;
	 ...
	 * @generated
	 */
	protected DiseasepredicatesFactory diseasepredicatesFactory = diseasepredicatesPackage.getDiseasepredicatesFactory();
	 ...
	 * @generated
	 */
	protected DiseasepredicatesModelWizardInitialObjectCreationPage initialObjectCreationPage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(DiseasemodelsEditorPlugin.INSTANCE.getImage("full/wizban/NewDiseasepredicates"))); //$NON-NLS-1$
	}
	...
	protected Collection<String> getInitialObjectNames() {
		if (initialObjectNames == null) {
			...
			for (EClassifier eClassifier : diseasepredicatesPackage.getEClassifiers()) {
	...
	protected EObject createInitialModel() {
		EClass eClass = (EClass)diseasepredicatesPackage.getEClassifier(initialObjectCreationPage.getInitialObjectName());
		EObject rootObject = diseasepredicatesFactory.create(eClass);
		return rootObject;
	}
	 ...
	 * @generated
	 */
	public class DiseasepredicatesModelWizardInitialObjectCreationPage extends WizardPage {
		/**
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 ...
		 * @generated
		 */
		public DiseasepredicatesModelWizardInitialObjectCreationPage(String pageId) {
			super(pageId);
		}
			...
			resourceURIBrowseFileSystemButton.addSelectionListener
				(new SelectionAdapter() {
					 ...
					 public void widgetSelected(SelectionEvent event) {
						 String[] filters = DiseasepredicatesEditor.FILE_EXTENSION_FILTERS.toArray(new String[DiseasepredicatesEditor.FILE_EXTENSION_FILTERS.size()]);
	...
	public void addPages() {
		initialObjectCreationPage = new DiseasepredicatesModelWizardInitialObjectCreationPage("Whatever2"); //$NON-NLS-1$
		initialObjectCreationPage.setTitle(DiseasemodelsEditorPlugin.INSTANCE.getString("_UI_DiseasepredicatesModelWizard_label")); //$NON-NLS-1$
