...
/**
 * This is an example of a Diseasepredicates model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiseasepredicatesEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(DiseasepredicatesModelWizard.FILE_EXTENSIONS, "*."); //$NON-NLS-1$
	...
	protected IPartListener partListener =
		new IPartListener() {
			public void partActivated(IWorkbenchPart p) {
				...
				else if (p == DiseasepredicatesEditor.this) {
					handleActivate();
				}
			}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(DiseasepredicatesEditor.this, false);
			}
			else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "org.eclipse.stem.ui.diseasemodels", //$NON-NLS-1$
					 0,
					 null,
	 ...
	 * @generated
	 */
	public DiseasepredicatesEditor() {
		super();
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), DiseasepredicatesEditor.this) {
						@Override
