...
import org.eclipse.stem.diseasemodels.predicates.diseasepredicates.presentation.DiseasepredicatesModelWizard;
...
public final class DiseasemodelsEditorAdvisor extends WorkbenchAdvisor {
	...
	/**
	 * About Handler for the RCP application.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	public static class AboutDiseaseModelHandler extends AbstractHandler {

	    @Override
	    public Object execute(ExecutionEvent event) throws ExecutionException {
	    	IWorkbenchWindow window = HandlerUtil
					.getActiveWorkbenchWindowChecked(event);
	    	MessageDialog.openInformation(window.getShell(), getString("_UI_About_title"), //$NON-NLS-1$
	 ...
	 * @generated NOT
	 */
	public static class OpenURICommand extends AbstractHandler {
	    ...
	    public Object execute(ExecutionEvent event) throws ExecutionException {
	    	...
	    	IWorkbenchWindow window = HandlerUtil
					.getActiveWorkbenchWindowChecked(event);
	    	LoadResourceAction.LoadResourceDialog loadResourceDialog = new LoadResourceAction.LoadResourceDialog(window.getShell());
			if (Window.OK == loadResourceDialog.open()) {
				for (URI uri : loadResourceDialog.getURIs()) {
					openEditor(window.getWorkbench(), uri);
				}
			}
			return null;
	    }
	 ...
	 * @generated NOT
	 */
	public static class OpenCommand extends AbstractHandler {
	    ...
	    public Object execute(ExecutionEvent event) throws ExecutionException {
	    	...
	    	IWorkbenchWindow window = HandlerUtil
					.getActiveWorkbenchWindowChecked(event);
	    	String[] filePaths = openFilePathDialog(window.getShell(), SWT.OPEN, null);
		if (filePaths.length > 0) {
			openEditor(window.getWorkbench(), URI.createFileURI(filePaths[0]));
		}
			return null;
	    }
	 ...
	 * @generated NOT
	 */
	public static class NewStanderdModelCommand extends AbstractHandler {
	 ...
	 * @generated NOT
	 */
	public static class NewDieseasePredicatesCommand extends AbstractHandler {
	    ...
	    public Object execute(ExecutionEvent event) throws ExecutionException {
	    	...
	    	IWorkbenchWindow window = HandlerUtil
					.getActiveWorkbenchWindowChecked(event);
	    	DiseasepredicatesModelWizard wizard = new DiseasepredicatesModelWizard();
		wizard.init(window.getWorkbench(), StructuredSelection.EMPTY);
		WizardDialog wizardDialog = new WizardDialog(window.getShell(), wizard);
		wizardDialog.open();
		return null;
