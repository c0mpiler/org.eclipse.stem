...
public class MultipopulationPackageImpl extends EPackageImpl implements MultipopulationPackage {
	...
	public void createPackageContents() {
		...
		createEAttribute(multiPopulationSeasonalDiseaseModelEClass, MULTI_POPULATION_SEASONAL_DISEASE_MODEL__USE_SPLINE_INTERPOLATION);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMultiPopulationSeasonalDiseaseModel_UseSplineInterpolation(), theEcorePackage.getEBoolean(), "useSplineInterpolation", null, 0, 1, MultiPopulationSeasonalDiseaseModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
