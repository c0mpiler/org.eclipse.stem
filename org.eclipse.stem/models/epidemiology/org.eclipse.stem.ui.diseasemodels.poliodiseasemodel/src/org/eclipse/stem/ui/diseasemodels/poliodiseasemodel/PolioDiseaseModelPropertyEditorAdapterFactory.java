 ...
 * 
 */
public class PolioDiseaseModelPropertyEditorAdapterFactory extends
	 ...
	 * 
	 */
	public PolioDiseaseModelPropertyEditorAdapterFactory() {
		super();
	...
	public Adapter createOralPolioVaccineModelAdapter() {
		return new PolioDiseaseModelAdapter();
	}
