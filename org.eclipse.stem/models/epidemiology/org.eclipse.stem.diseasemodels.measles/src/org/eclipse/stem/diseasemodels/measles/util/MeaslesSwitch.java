...
public class MeaslesSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MeaslesPackage.MEASLES_LABEL: {
				MeaslesLabel measlesLabel = (MeaslesLabel)theEObject;
				T1 result = caseMeaslesLabel(measlesLabel);
				if (result == null) result = caseStandardDiseaseModelLabel(measlesLabel);
				if (result == null) result = caseDiseaseModelLabel(measlesLabel);
				if (result == null) result = caseIntegrationLabel(measlesLabel);
				if (result == null) result = caseDynamicNodeLabel(measlesLabel);
				if (result == null) result = caseDynamicLabel(measlesLabel);
				if (result == null) result = caseNodeLabel(measlesLabel);
				if (result == null) result = caseLabel(measlesLabel);
				if (result == null) result = caseIdentifiable(measlesLabel);
				if (result == null) result = caseComparable(measlesLabel);
				if (result == null) result = caseSanityChecker(measlesLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeaslesPackage.MEASLES_LABEL_VALUE: {
				MeaslesLabelValue measlesLabelValue = (MeaslesLabelValue)theEObject;
				T1 result = caseMeaslesLabelValue(measlesLabelValue);
				if (result == null) result = caseSEIRLabelValue(measlesLabelValue);
				if (result == null) result = caseSIRLabelValue(measlesLabelValue);
				if (result == null) result = caseSILabelValue(measlesLabelValue);
				if (result == null) result = caseStandardDiseaseModelLabelValue(measlesLabelValue);
				if (result == null) result = caseDiseaseModelLabelValue(measlesLabelValue);
				if (result == null) result = caseIntegrationLabelValue(measlesLabelValue);
				if (result == null) result = caseLabelValue(measlesLabelValue);
				if (result == null) result = casePrimitiveTypeOperations(measlesLabelValue);
				if (result == null) result = caseSanityChecker(measlesLabelValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeaslesPackage.MEASLES: {
				Measles measles = (Measles)theEObject;
				T1 result = caseMeasles(measles);
				if (result == null) result = caseMultiPopulationSEIRDiseaseModel(measles);
				if (result == null) result = caseMultiPopulationSIRDiseaseModel(measles);
				if (result == null) result = caseMultiPopulationSIDiseaseModel(measles);
				if (result == null) result = caseStandardDiseaseModel(measles);
				if (result == null) result = caseDiseaseModel(measles);
				if (result == null) result = caseIntegrationDecorator(measles);
				if (result == null) result = caseModifiable(measles);
				if (result == null) result = caseNodeDecorator(measles);
				if (result == null) result = caseDecorator(measles);
				if (result == null) result = caseIdentifiable(measles);
				if (result == null) result = caseComparable(measles);
				if (result == null) result = caseSanityChecker(measles);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T1 caseMeaslesLabel(MeaslesLabel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseMeaslesLabelValue(MeaslesLabelValue object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Measles</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Measles</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseMeasles(Measles object) {
		return null;
	}
