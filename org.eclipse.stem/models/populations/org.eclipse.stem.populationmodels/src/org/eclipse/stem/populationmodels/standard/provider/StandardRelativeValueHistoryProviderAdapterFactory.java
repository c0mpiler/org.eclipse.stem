...
public class StandardRelativeValueHistoryProviderAdapterFactory extends
	...
	public Adapter createPopulationModelLabelAdapter() {
		return new PopulationModelLabelRelativeValueHistoryProvider(
	...
	/**
	 * This class is a Relative Value History Provider for PopulationModelLabel
	 ...
	 * 
	 * @see PopulationModelLabelValueRelativeValueHistoryProvider
	 */
	public static class PopulationModelLabelRelativeValueHistoryProvider extends
		 ...
		 */
		public PopulationModelLabelRelativeValueHistoryProvider(
		...
		} // PopulationModelLabelRelativeValueHistoryProvider
		...
		/**
		 * 
		 * TODO Perhaps for Populations we should model a denominator....
		 * 
...
//			if(StandardRelativeValueProviderAdapterFactory.dynamicDenominatorMap.containsKey(feature)) {
//				return StandardRelativeValueProviderAdapterFactory.dynamicDenominatorMap.get(feature).doubleValue();
//			} else {
//				StandardRelativeValueProviderAdapterFactory.dynamicDenominatorMap.put(feature, Double.valueOf(1.0));
//				return 1.0;
//			}
		...
		public double getRelativeValue(final EStructuralFeature feature,
			...
			final PopulationModelLabel dml = (PopulationModelLabel) historyProviderAdapter
					.getInstance(time);
		...
		public double[] getAllHistoricRelativeValues(
			...
			for (Identifiable identifiable : historicValues) {
				final PopulationModelLabel dml = (PopulationModelLabel) identifiable;
				final RelativeValueProviderAdapter rvp = (RelativeValueProviderAdapter) RelativeValueProviderAdapterFactory.INSTANCE
						.adapt(dml, RelativeValueProvider.class);
