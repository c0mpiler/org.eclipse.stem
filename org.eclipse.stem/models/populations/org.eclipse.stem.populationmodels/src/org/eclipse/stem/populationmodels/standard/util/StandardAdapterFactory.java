...
public class StandardAdapterFactory extends AdapterFactoryImpl {
	...
	protected StandardSwitch<Adapter> modelSwitch =
		new StandardSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAgingPopulationModel(AgingPopulationModel object) {
				return createAgingPopulationModelAdapter();
			}
			@Override
			public Adapter caseAgeGroup(AgeGroup object) {
				return createAgeGroupAdapter();
			}
			@Override
			public Adapter caseExternalDataSourcePopulationInitializer(ExternalDataSourcePopulationInitializer object) {
				return createExternalDataSourcePopulationInitializerAdapter();
			}
			@Override
			public Adapter caseExternalDataSourcePopulationModel(ExternalDataSourcePopulationModel object) {
				return createExternalDataSourcePopulationModelAdapter();
			}
			@Override
			public Adapter caseSinModulatePopulationModel(SinModulatePopulationModel object) {
				return createSinModulatePopulationModelAdapter();
			}
			@Override
			public Adapter caseSeasonalMigratoryPopulationModel(SeasonalMigratoryPopulationModel object) {
				return createSeasonalMigratoryPopulationModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.AgingPopulationModel <em>Aging Population Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.AgeGroup <em>Age Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.ExternalDataSourcePopulationInitializer <em>External Data Source Population Initializer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.ExternalDataSourcePopulationModel <em>External Data Source Population Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.SinModulatePopulationModel <em>Sin Modulate Population Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.populationmodels.standard.SeasonalMigratoryPopulationModel <em>Seasonal Migratory Population Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
